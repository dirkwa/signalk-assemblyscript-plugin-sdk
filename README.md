...
```typescript
import { createSimpleDelta, getCurrentTimestamp } from '@signalk/assemblyscript-plugin-sdk'
...
// Objects
const pathValue = new PathValue('position', '{"latitude":60.1,"longitude":24.9}')
...
- [Signal K WASM Plugin Guide](../../../.claude/WASM_PLUGIN_DEV_GUIDE.md)
